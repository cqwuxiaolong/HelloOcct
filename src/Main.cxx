...
{
  QCoreApplication::setOrganizationName("Lamoh Co,Ltd");
  QCoreApplication::setOrganizationDomain("cqwuxiaolong@qq.com");
  QCoreApplication::setApplicationName("LamohCad");
